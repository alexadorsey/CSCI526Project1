...
function OnGUI(){
	var startButton = GUI.Button (Rect (Screen.width/2 - 50, (Screen.height/8) * 4, 200, 50), "START", startButtonStyle);
	if (startButton) {
    ...
    if (GUI.Button (Rect (Screen.width/2 - 50, (Screen.height / 4) * 3 , 200, 50), "ABOUT", aboutButtonStyle)) {
    	Application.LoadLevel("Levels");
